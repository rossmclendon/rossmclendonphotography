...
This is the bit of the blog that's probalby most helpful for new solar eclipse photographers since you can't practice shooting a total eclipse unitl it happens.  The corona is extremely dynamic, very bright toward the center and dimly extending out many times the diameter of the sun's photosphere (the bright part).  I took a bunch of exposures during totality in 2017.  I put them together into a video along with the exposure info.  Each photo here is rendered from Lightroom without any adjustments using a very neutral profile to give the best possible representation of how a given exposure renders the various eclipse detail.
